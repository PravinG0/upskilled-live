    ...
    <section className="relative" aria-label="AI Features">
      ...
      <div className="relative h-[25vh]" style={{ zIndex: 2 }}>
        <svg
          ...
          aria-hidden="true"
        >
          {/* Fill shape matching background */}
          <path
            fill="#000000"
          ...
          />
          {/* Yellow border along the curve */}
          <path
            fill="none"
            stroke="rgb(255,208,0)"
            strokeWidth="2.5"
            d="M0,224L60,213.3C120,203,240,181,360,181.3C480,181,600,203,720,224C840,245,960,267,1080,261.3C1200,256,1320,224,1380,208L1440,192"
          />
        </svg>
      </div>
